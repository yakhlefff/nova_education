...
class MulGameScreen extends StatefulWidget {
  final String languageCode; // ar / fr / en
  const MulGameScreen({super.key, required this.languageCode});

  @override
  State<MulGameScreen> createState() => _MulGameScreenState();
}

class _MulGameScreenState extends State<MulGameScreen> {
  ...
  Color get _accent => _palette[(_a * 7 + _b * 3) % _palette.length];
  ...
  // ✅ الضرب خاصه تدرج مختلف (باش يبقى مناسب للابتدائي)
  // Level 1: 0..5
  // Level 2: 0..9
  // Level 3: 0..12
  // Level 4: 0..15
  ...
  // Keys
  String _kStars() => "mul_stars";
  String _kLevel() => "mul_level";
  String _kScore() => "mul_score";
  String _kLevelCorrect() => "mul_level_correct";
  String _kLevelWrong() => "mul_level_wrong";
  String _kCorrectFor(int level) => "mul_correct_L$level";
  String _kWrongFor(int level) => "mul_wrong_L$level";
