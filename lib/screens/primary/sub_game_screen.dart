...
class SubGameScreen extends StatefulWidget {
  final String languageCode; // ar / fr / en
  const SubGameScreen({super.key, required this.languageCode});

  @override
  State<SubGameScreen> createState() => _SubGameScreenState();
}

class _SubGameScreenState extends State<SubGameScreen> {
  ...
  // Keys
  String _kStars() => "sub_stars";
  String _kLevel() => "sub_level";
  String _kScore() => "sub_score";
  String _kLevelCorrect() => "sub_level_correct";
  String _kLevelWrong() => "sub_level_wrong";
  String _kCorrectFor(int level) => "sub_correct_L$level";
  String _kWrongFor(int level) => "sub_wrong_L$level";
